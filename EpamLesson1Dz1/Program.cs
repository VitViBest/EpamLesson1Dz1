...
namespace EpamLesson1Dz1
{
    ...
    class Program
    {
        private static List<Contact> _Сontacts;

        static void Main(string[] args)
        {
            _Сontacts = new List<Contact>();
            int action = 0;
            do
            {
                Console.Clear();
        ...
        {
            int t = TakeIndex();
            Console.WriteLine(_Сontacts[t].GetInfo());
            Console.ReadKey();
        }
        ...
        {
            int t = TakeIndex();
            _Сontacts.RemoveAt(t);
        }

        static void Add()
        {
            _Сontacts.Add(Create());
        }
